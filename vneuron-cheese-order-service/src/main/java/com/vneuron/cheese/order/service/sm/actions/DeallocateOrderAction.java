...
@Component
public class DeallocateOrderAction implements Action<CheeseOrderStatusEnum, CheeseOrderEventEnum> {
        ...
        cheeseOrderOptional.ifPresentOrElse(cheeseOrder -> {
            jmsTemplate.convertAndSend(JmsConfig.DEALLOCATE_ORDER_QUEUE,
                    DeallocateOrderRequest.builder()
                            ...
                            .build());
            log.debug("Sent Deallocation Request for order id: " + cheeseOrderId);
